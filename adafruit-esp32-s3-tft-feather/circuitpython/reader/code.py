...
# load fonts
font = bitmap_font.load_font("/fonts/SourceCodePro-Regular-18.bdf")
author_font = bitmap_font.load_font("/fonts/SourceCodePro-Regular-20.bdf")

# configure labels
message_label = label.Label(terminalio.FONT, text=prompt, color=0x606060, x=24, y=60)
display.append(message_label)

reader_label = label.Label(font, text="", color=0xf9e4bc, x=24, y=60)
display.append(reader_label)

author_label = label.Label(author_font, text="", color=0xef9d6e, x=24, y=60)
